...
CREATE TABLE statuses (
  ...
  record_type INT UNSIGNED COMMENT 'Тип записи', -- id record_types
  created_at DATETIME DEFAULT NOW(),
  updated_at DATETIME DEFAULT NOW() ON UPDATE NOW(),
  INDEX statuses_status_record_type_lastname_idx (status, record_type),
  CONSTRAINT statuses_record_type_fk FOREIGN KEY (record_type) REFERENCES record_types(id)
...
CREATE TABLE operators (
  ...
  userrole INT UNSIGNED COMMENT 'тип учетной записи', -- id userroles
  created_at DATETIME DEFAULT NOW(),
  updated_at DATETIME DEFAULT NOW() ON UPDATE NOW(),
  INDEX operators_login_idx (login),
  CONSTRAINT operators_userrole_fk FOREIGN KEY (userrole) REFERENCES userroles(id) 
...
CREATE TABLE contacts (
  ...
  `position` INT UNSIGNED COMMENT 'должность', -- id positions
  department INT UNSIGNED COMMENT 'подразделение', -- id depts
  ...
  CONSTRAINT contacts_position_fk FOREIGN KEY (`position`) REFERENCES positions(id),
  CONSTRAINT contacts_department_fk FOREIGN KEY (department) REFERENCES depts(id) 
...
CREATE TABLE knowledges (
  ...
  `type` INT UNSIGNED COMMENT 'тип записи', -- id record_types
  created_at DATETIME DEFAULT NOW(),
  updated_at DATETIME DEFAULT NOW() ON UPDATE NOW(),
  CONSTRAINT knowledges_author_id_fk FOREIGN KEY (author_id) REFERENCES operators(id),
  CONSTRAINT knowledges_type_fk FOREIGN KEY (`type`) REFERENCES record_types(id)
...
CREATE TABLE interactions (
  ...
  closure_code INT UNSIGNED COMMENT 'код закрытия', -- id closure_codes
  device_id INT UNSIGNED COMMENT 'затронутая конфигурационная единица',  -- id devices
  int_type INT UNSIGNED COMMENT 'тип обращения', -- ЗНО или Инцидент -- id record_types
  priority INT UNSIGNED NOT NULL COMMENT 'приоритет обращения', -- id priorities
  status INT UNSIGNED NOT NULL COMMENT 'статус обращения', -- id statuses
  `type` INT UNSIGNED COMMENT 'тип записи', -- id record_types
  created_at DATETIME DEFAULT NOW(),
  updated_at DATETIME DEFAULT NOW() ON UPDATE NOW(),
  CONSTRAINT interactions_contact_id_fk FOREIGN KEY (contact_id) REFERENCES operators(id),
  CONSTRAINT interactions_closure_code_fk FOREIGN KEY (closure_code) REFERENCES closure_codes(id),
  CONSTRAINT interactions_device_id_fk FOREIGN KEY (device_id) REFERENCES devices(id),
  CONSTRAINT interactions_int_type_fk FOREIGN KEY (int_type) REFERENCES record_types(id),
  CONSTRAINT interactions_priority_fk FOREIGN KEY (priority) REFERENCES priorities(id),
  CONSTRAINT interactions_status_fk FOREIGN KEY (status) REFERENCES statuses(id),
  CONSTRAINT interactions_type_fk FOREIGN KEY (`type`) REFERENCES record_types(id)
...
CREATE TABLE incidents (
  ...
  resolution TEXT COMMENT 'решение',
  closure_code INT UNSIGNED COMMENT 'код закрытия', -- id closure_codes
  priority INT UNSIGNED NOT NULL COMMENT 'приоритет', -- id priorities
  status INT UNSIGNED NOT NULL COMMENT 'статус инцидента', -- id statuses
  ...
  CONSTRAINT incidents_closure_code_fk FOREIGN KEY (closure_code) REFERENCES closure_codes(id),
  CONSTRAINT incidents_priority_fk FOREIGN KEY (priority) REFERENCES priorities(id),
  CONSTRAINT incidents_status_fk FOREIGN KEY (status) REFERENCES statuses(id),
  ...
  CONSTRAINT incidents_type_fk FOREIGN KEY (`type`) REFERENCES record_types(id)
...
CREATE TABLE requests (
  ...
  closure_code INT UNSIGNED COMMENT 'код закрытия', -- id closure_codes
  priority INT UNSIGNED NOT NULL COMMENT 'приоритет', -- id priorities
  status INT UNSIGNED NOT NULL COMMENT 'статус ЗНО', -- id statuses
  group_id INT UNSIGNED COMMENT 'ответственная группа',  -- id assignment_groups
  assignee_id INT UNSIGNED COMMENT 'ответственный исполнитель', -- id operators
  device_id INT UNSIGNED COMMENT 'затронутая конфигурационная единица', -- id devices 
  `type` INT UNSIGNED COMMENT 'тип записи', -- id record_types
  ...
  CONSTRAINT requests_closure_code_fk FOREIGN KEY (closure_code) REFERENCES closure_codes(id),
  CONSTRAINT requests_priority_fk FOREIGN KEY (priority) REFERENCES priorities(id),
  CONSTRAINT requests_status_fk FOREIGN KEY (status) REFERENCES statuses(id),
  ...
  CONSTRAINT requests_type_fk FOREIGN KEY (`type`) REFERENCES record_types(id)
...
CREATE TABLE routineworks (
  ...
  status INT UNSIGNED NOT NULL COMMENT 'статус регламентной работы', -- id statuses
  group_id INT UNSIGNED COMMENT 'ответственная группа', -- id assignment_groups
  assignee_id INT UNSIGNED COMMENT 'ответственный исполнитель', -- id operators
  description TEXT COMMENT 'подробное описание',
  ...
  CONSTRAINT routineworks_status_fk FOREIGN KEY (status) REFERENCES statuses(id),
  ...
  CONSTRAINT routineworks_type_fk FOREIGN KEY (`type`) REFERENCES record_types(id)
...
CREATE TABLE relations (
  ...
  record_1_type INT UNSIGNED NOT NULL, -- id record_types
  record_2_id INT UNSIGNED NOT NULL COMMENT 'вызванная запись', -- id
  record_2_type INT UNSIGNED NOT NULL, -- id record_types
  created_at DATETIME DEFAULT NOW(),
  updated_at DATETIME DEFAULT NOW() ON UPDATE NOW(),
  PRIMARY KEY (record_1_id, record_1_type, record_2_id, record_2_type),
  CONSTRAINT relations_record_1_type_fk FOREIGN KEY (record_1_type) REFERENCES record_types(id),
  CONSTRAINT relations_record_2_type_fk FOREIGN KEY (record_2_type) REFERENCES record_types(id)
